...
export class $1673861532620 implements MigrationInterface {
    name = '$1673861532620'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "todos" ("id" SERIAL NOT NULL, "name" character varying(500) NOT NULL, "description" text NOT NULL, "status" boolean NOT NULL, "user_id" integer NOT NULL, "group_id" integer NOT NULL, "create_at" TIMESTAMP DEFAULT now(), "update_at" TIMESTAMP DEFAULT now(), "delete_at" TIMESTAMP, CONSTRAINT "PK_ca8cafd59ca6faaf67995344225" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`ALTER TABLE "todos" ADD CONSTRAINT "FK_fef55ecca4048b87201a9fdef7c" FOREIGN KEY ("group_id") REFERENCES "groups"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "todos" DROP CONSTRAINT "FK_fef55ecca4048b87201a9fdef7c"`);
